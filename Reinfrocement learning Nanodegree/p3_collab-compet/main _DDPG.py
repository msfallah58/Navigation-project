...
environment = UnityEnvironment(file_name="/home/saber/deep-reinforcement-learning/p3_collab-compet/Tennis_Linux"
                                         "/Tennis.x86_64", no_graphics=False)
...
def train_agent(env=environment, num_agents=number_of_agents, n_episodes=5000, t_max=2000):
    """
