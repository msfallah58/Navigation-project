...
model_name= 'darknet'  #'fpn-resnet' 
sequence = '1'
data_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'dataset', data_filename) # adjustable path in case this script is called from another working directory
results_fullpath = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'results', model_name,'results_sequence_'+sequence+'_darknet') #model_name
...
exec_tracking = ['show_detection_performance'] # options are 'perform_tracking'
