...
class Agent:
    ...
    def __init__(self, state_size, action_size, model_choice):
        ...
        # Q-Network
        self.network_local = Network(state_size, action_size).to(device) if model_choice == "DQN" or "DDQN" else \
            Dueling_Network(state_size, action_size).to(device)
        self.network_target = Network(state_size, action_size).to(device) if model_choice == "DQN" or "DDQN" else \
            Dueling_Network(state_size, action_size).to(device)
